...
class MetadataEnhancer:
    ...
    def generate_enhanced_metadata(self, analyzed_comments: AnalyzedComments, pr_info: Dict[str, Any], comment_counts: Dict[str, int]) -> List[str]:
        ...
        metadata_lines.append(f"- **Total Comments**: {total_comments} ({actionable} Actionable, {nitpick} Nitpick, {outside_diff} Outside Diff Range)")
    ...
    def _analyze_file_types(self, analyzed_comments: AnalyzedComments, pr_info: Dict[str, Any]) -> str:
    ...
    def _detect_technology_stack(self, analyzed_comments: AnalyzedComments, pr_info: Dict[str, Any]) -> str:
            ...
            for review in analyzed_comments.review_comments:
                for comment_list in [
                    ...
                    for comment in comment_list:
                        ...
                        if any(term in raw_content for term in ['command', 'syntax', 'shell', 'makefile']):
                            issue_categories['command syntax'] += 1
                        if any(term in raw_content for term in ['file', 'existence', 'check', 'missing']):
    ...
    def _assess_complexity_level(self, analyzed_comments: AnalyzedComments, pr_info: Dict[str, Any]) -> str:
    ...
    def _analyze_change_impact_scope(self, analyzed_comments: AnalyzedComments, pr_info: Dict[str, Any]) -> str:
    ...
    def _determine_testing_requirements(self, analyzed_comments: AnalyzedComments, pr_info: Dict[str, Any]) -> str:
    ...
    def _calculate_file_distribution(self, analyzed_comments: AnalyzedComments, pr_info: Dict[str, Any]) -> str:
    ...
    def _assess_risk_level(self, analyzed_comments: AnalyzedComments, pr_info: Dict[str, Any], comment_counts: Dict[str, int]) -> str:
    ...
    def _estimate_resolution_time(self, analyzed_comments: AnalyzedComments, pr_info: Dict[str, Any], comment_counts: Dict[str, int]) -> str:
            ...
            for review in analyzed_comments.review_comments:
                for comment_list in [
                    ...
                    for comment in comment_list:
                        ...
                        if any(term in raw_content for term in ['build system', 'makefile', 'shell script']):
