...
class OutputFormatter:
    ...
    def format_actionable_comments(self, comments: List[Any]) -> List[Dict[str, Any]]:
        ...
        for comment in comments:
            ...
            formatted_comment['priority_display'] = f"{self.priority_emojis.get(priority, '⚪')} {priority}"
    ...
    def format_for_display(self, comments: List[Dict[str, Any]], format_type: str = 'compact') -> str:
        ...
        for priority in ['HIGH', 'MEDIUM', 'LOW']:
            ...
            if priority_comments:
                ...
                for comment in priority_comments:
                    file_info = f"{comment['file_path']}:{comment.get('line_number', '')}" if comment['file_path'] else ""
