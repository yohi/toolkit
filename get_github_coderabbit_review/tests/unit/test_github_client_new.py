...
class TestGitHubClientRefactored:
    ...
    def test_get_comment_success(self, mock_run):
        ...
        result = self.client.get_comment(
            "https://github.com/owner/repo/pull/1",
            123456789
        )
        ...
        mock_run.assert_called_once_with([
            "gh", "api",
            "/repos/owner/repo/issues/comments/123456789"
    ...
    def test_get_latest_comments_success(self, mock_run):
        ...
        result = self.client.get_latest_comments(
            "https://github.com/owner/repo/pull/1",
            5
        )
    ...
    def test_error_message_quality(self, mock_run):
        ...
        mock_run.return_value = MagicMock(
            returncode=1,
            stderr="HTTP 404: Not Found (https://docs.github.com/rest)"
        )
