...
class TestGitHubIntegration(unittest.TestCase):
    ...
    def test_fetch_pr_comments_success(self, mock_run):
        ...
        mock_responses = [
            ...
            MagicMock(returncode=0, stdout=json.dumps(MOCK_GH_PR_RESPONSE), stderr=""),
            # Second call: get comments
            MagicMock(returncode=0, stdout=json.dumps(MOCK_GH_COMMENTS_RESPONSE), stderr=""),
        ]
    ...
    def test_fetch_pr_comments_not_found(self, mock_run):
        ...
        mock_run.return_value = MagicMock(
            returncode=1, stdout="", stderr=MOCK_GH_ERROR_RESPONSES["not_found_error"]["stderr"]
        )
    ...
    def test_check_rate_limits(self, mock_run):
        ...
        mock_run.return_value = MagicMock(
            returncode=0, stdout=json.dumps(MOCK_RATE_LIMIT_RESPONSE), stderr=""
        )
    ...
    def test_validate_github_cli_available(self, mock_run):
        ...
        mock_run.return_value = MagicMock(
            returncode=0, stdout=MOCK_SUCCESS_RESPONSES["gh_version"]["stdout"], stderr=""
        )
...
class TestGitHubIntegrationEdgeCases(unittest.TestCase):
    ...
    def test_large_comments_response(self, mock_run):
        ...
        mock_responses = [
            ...
            MagicMock(returncode=0, stdout=json.dumps(MOCK_LARGE_COMMENTS_RESPONSE), stderr=""),
        ]
        mock_run.side_effect = mock_responses
    ...
    def test_unicode_content_handling(self, mock_run):
        ...
        mock_responses = [
            ...
            MagicMock(returncode=0, stdout=json.dumps(MOCK_GH_PR_RESPONSE), stderr=""),
            # Unicode comments
            MagicMock(returncode=0, stdout=json.dumps([unicode_comment]), stderr=""),
        ]
        mock_run.side_effect = mock_responses
